...
rule test {{
    ...
    def _maybe_sample_fds(self):
        ...
        files that were scanned and did not match: on the Round 2 flood that was under
        half the scan, and on a ruleset matching everything it never ran at all. FD
        monitoring went quiet exactly when the scanner held the most handles.
        ...
        left identical evidence - which is why this capability was filed unobservable.
    ...
    def scan_file(self, file_path):
        ...
        try:
            # Before every early return: sampling must not depend on a file surviving to
